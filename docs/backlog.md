...
- **Design-spec reconciliation — in-flight (2 building, HO 242–243)** (RESOLVED 2026-06-13). Design adjudicated the five unbuilt specs: three were building, three closed-no-build (struck from this ledger, tombstoned in DONE). In-flight pointers, each closed when it ships:
  - (a) **Trends TIMELINE chart** — building, **HO 243**. Calendar-axis introductions line alongside `BillsTimeSeries`; stays under Patterns (top-nav promotion rejected); COMPARE overlay dropped (no 118th intros).
