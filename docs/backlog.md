...
- **Design-spec reconciliation — in-flight (3 building, HO 241–243)** (RESOLVED 2026-06-13). Design adjudicated the five unbuilt specs: three are building, three closed-no-build (struck from this ledger, tombstoned in DONE). In-flight pointers, each closed when it ships:
  ...
  - (e) **NEWS SIGNAL cut** — building, **HO 241**. Aligned to the app-wide 72h breaking window, not the spec's 48h.
